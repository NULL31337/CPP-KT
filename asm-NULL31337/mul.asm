...
; save r10 to rdi
                ...
                mov             rbx, [rsi + 8 * r15]
                call            mul_long_short             
                call            add_long_long_displacement
...
; adds two long number with displacement
;    r11 -- address of summand #1 (long number)
;    rdi -- address of summand #2 (long number)
;    rcx -- length of long numbers in qwords
;    r15 -- length displacement         
; result:
;    sum is written to r11
add_long_long_displacement:
                push            rdi
                push            rcx 
                push            r11
